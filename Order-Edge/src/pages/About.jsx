...
function About() {
	return (
		<Container className="border border-red-50">
			<section className="mx-auto py-16">
				<div className="grid grid-cols-1 px-4 md:grid-cols-2 gap-16">
					<div className="about-us__content">
						<h2 className="text-3xl font-bold mb-4">Our Story</h2>
						<p className="text-gray-700 leading-relaxed">
							Lorem ipsum dolor sit amet, consectetur adipiscing
							elit. Maecenas metus magna, dictum sit amet dolor
							non, pulvinar porta lorem. Sed posuere consectetur
							est at lobortis. Praesent sapien massa, convallis a
							pharetra eget, vestibulum at eros. Aenean eu leo
						...
						<p className="text-gray-700 leading-relaxed mt-4">
							...
							dolor malesuada ullamcorper. Morbi leo risus, porta
							ac consectetur ac, visac sit amet amet. Aliquam erat
