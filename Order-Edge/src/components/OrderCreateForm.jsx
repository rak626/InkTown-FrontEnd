...
const OrderCreateForm = () => {
  ...
  const onSubmit = (data) => {
    const newData = {
      ...
      customerEmail: isCustomer ? 'inktown.dev@gamil.com' : data.customerName,
      customerPhoneNo: isCustomer ? curUser.userPhoneNo : data.customerPhoneNo,
      length: 10,
      width: 10,
      isEyelet: true,
      quantity: 1,
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              {errors.customerEmail && (
                <span className="text-red-500">Customer Email is required</span>
              )}
            </div>
            <div className="mb-4">
              <label
